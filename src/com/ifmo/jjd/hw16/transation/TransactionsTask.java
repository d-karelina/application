package com.ifmo.jjd.hw16.transation;
...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String,Long> transactions = transactionStream
                .collect(Collectors.groupingBy(key -> key.getAccount().getNumber(),
                        Collectors.summingLong(Transaction::getSum))
                );

        /*Map<String,Long> transactions2 = transactionStream
