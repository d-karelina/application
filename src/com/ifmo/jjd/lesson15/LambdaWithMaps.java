...
public class LambdaWithMaps {
    public static void main(String[] args) {
        ...
        // merge, computeIfAbsent - методы посмотреть самостоятельно !!!
        // tasksMap.entrySet() // Entry: key, value
        ...
        tasksMap.forEach((key, value) -> value.getParticipants().forEach(System.out::println)) ;
